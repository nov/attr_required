...
REQUIRED and OPTIONAL is common terminology in RFCs, and used for protocol parameters.
This gem helps those protocol library developers to define which are REQUIRED and which are OPTIONAL.
